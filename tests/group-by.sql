...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.X ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.X ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION, COUNT(*) INTEGER)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.X ASC, PUBLIC.FOO.Y ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION, Y CHARACTER VARYING(32))
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.Y ASC, PUBLIC.FOO.X ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), X DOUBLE PRECISION)
-- EXPLAIN: EXPR (X DOUBLE PRECISION, Y CHARACTER VARYING(32))
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.X ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION, COUNT(PUBLIC.FOO.X) INTEGER)
-- EXPLAIN: EXPR (X DOUBLE PRECISION, COL2 INTEGER)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), MIN(PUBLIC.FOO.X) DOUBLE PRECISION)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY PUBLIC.FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), MAX(PUBLIC.FOO.X) DOUBLE PRECISION)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: WHERE PUBLIC.FOO.Y = 'hello'
-- EXPLAIN: ORDER BY PUBLIC.FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), AVG(PUBLIC.FOO.X) DOUBLE PRECISION)
-- EXPLAIN: EXPR (Y CHARACTER VARYING(32), COL2 DOUBLE PRECISION)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: GROUP BY (MIN(PUBLIC.FOO.X) DOUBLE PRECISION, MAX(PUBLIC.FOO.X) DOUBLE PRECISION)
...
-- EXPLAIN: TABLE PUBLIC.FOO (PUBLIC.FOO.X DOUBLE PRECISION, PUBLIC.FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: GROUP BY (AVG(PUBLIC.FOO.X * 2) DOUBLE PRECISION)
...
-- EXPLAIN: ORDER BY PUBLIC.FOO.X ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION)
-- EXPLAIN: ORDER BY PUBLIC.FOO.X DESC
-- EXPLAIN: FETCH FIRST 2 ROWS ONLY
-- EXPLAIN: EXPR (X DOUBLE PRECISION)
...
-- error 42601: syntax error: nested aggregate functions are not supported: MIN(PUBLIC.FOO.X) * AVG(PUBLIC.FOO.X)
