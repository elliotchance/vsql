...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY FOO.X ASC, FOO.Y ASC
...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY FOO.X ASC
-- EXPLAIN: GROUP BY (X DOUBLE PRECISION, COUNT(FOO.X) INTEGER)
-- EXPLAIN: EXPR (X DOUBLE PRECISION, COL2 INTEGER)
...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), MIN(FOO.X) DOUBLE PRECISION)
...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: ORDER BY FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), MAX(FOO.X) DOUBLE PRECISION)
...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: WHERE FOO.Y = 'hello'
-- EXPLAIN: ORDER BY FOO.Y ASC
-- EXPLAIN: GROUP BY (Y CHARACTER VARYING(32), AVG(FOO.X) DOUBLE PRECISION)
-- EXPLAIN: EXPR (Y CHARACTER VARYING(32), COL2 DOUBLE PRECISION)
...
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: GROUP BY (MIN(FOO.X) DOUBLE PRECISION, MAX(FOO.X) DOUBLE PRECISION)
-- EXPLAIN: EXPR (COL1 DOUBLE PRECISION, COL2 DOUBLE PRECISION)

SELECT min(x), max(x) FROM foo;
-- COL1: 1.234 COL2: 12.34

EXPLAIN SELECT avg(x * 2) FROM foo;
-- EXPLAIN: TABLE FOO (FOO.X DOUBLE PRECISION, FOO.Y CHARACTER VARYING(32))
-- EXPLAIN: GROUP BY (AVG(FOO.X * 2) DOUBLE PRECISION)
...
-- error 42601: syntax error: nested aggregate functions are not supported: MIN(FOO.X) * AVG(FOO.X)
