...
EXPLAIN SELECT * FROM t1 JOIN t2 ON TRUE;
-- EXPLAIN: $1:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T1 (F1 INTEGER, F2 INTEGER)
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T2 (F3 INTEGER, F4 INTEGER)
-- EXPLAIN: INNER JOIN ON TRUE (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
...
EXPLAIN SELECT * FROM t1 JOIN t2 ON f1 = f3;
-- EXPLAIN: $1:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T1 (F1 INTEGER, F2 INTEGER)
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T2 (F3 INTEGER, F4 INTEGER)
-- EXPLAIN: INNER JOIN ON ":memory:".PUBLIC.T1.F1 = ":memory:".PUBLIC.T2.F3 (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: EXPR (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)

SELECT * FROM t1 JOIN t2 ON f1 = f3;
-- F1: 123 F2: 1 F3: 123 F4: 5
-- F1: 789 F2: 3 F3: 789 F4: 6

EXPLAIN SELECT * FROM t1 JOIN t2 ON f1 = f3 ORDER BY f3 DESC;
-- EXPLAIN: $1:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T1 (F1 INTEGER, F2 INTEGER)
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T2 (F3 INTEGER, F4 INTEGER)
-- EXPLAIN: INNER JOIN ON ":memory:".PUBLIC.T1.F1 = ":memory:".PUBLIC.T2.F3 (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: ORDER BY ":memory:".PUBLIC.T2.F3 DESC
-- EXPLAIN: EXPR (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)

SELECT * FROM t1 JOIN t2 ON f1 = f3 ORDER BY f3 DESC;
-- F1: 789 F2: 3 F3: 789 F4: 6
-- F1: 123 F2: 1 F3: 123 F4: 5
