...
-- EXPLAIN: LEFT JOIN ON TRUE (T1.F1 INTEGER, T1.F2 INTEGER, T2.F3 INTEGER, T2.F4 INTEGER)
...
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE T2 (T2.F3 INTEGER, T2.F4 INTEGER)
-- EXPLAIN: LEFT JOIN ON T1.F1 = T2.F3 (T1.F1 INTEGER, T1.F2 INTEGER, T2.F3 INTEGER, T2.F4 INTEGER)
-- EXPLAIN: EXPR (F1 INTEGER, F2 INTEGER, F3 INTEGER, F4 INTEGER)
...
-- EXPLAIN:   TABLE T2 (T2.F3 INTEGER, T2.F4 INTEGER)
-- EXPLAIN: LEFT JOIN ON T1.F1 = T2.F3 (T1.F1 INTEGER, T1.F2 INTEGER, T2.F3 INTEGER, T2.F4 INTEGER)
-- EXPLAIN: ORDER BY T2.F3 ASC, T1.F1 ASC
-- EXPLAIN: EXPR (F1 INTEGER, F2 INTEGER, F3 INTEGER, F4 INTEGER)
