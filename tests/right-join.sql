...
-- EXPLAIN: RIGHT JOIN ON TRUE (PUBLIC.T1.F1 INTEGER, PUBLIC.T1.F2 INTEGER, PUBLIC.T2.F3 INTEGER, PUBLIC.T2.F4 INTEGER)
...
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE PUBLIC.T2 (PUBLIC.T2.F3 INTEGER, PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: RIGHT JOIN ON PUBLIC.T1.F1 = PUBLIC.T2.F3 (PUBLIC.T1.F1 INTEGER, PUBLIC.T1.F2 INTEGER, PUBLIC.T2.F3 INTEGER, PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: EXPR (F1 INTEGER, F2 INTEGER, F3 INTEGER, F4 INTEGER)
...
-- EXPLAIN:   TABLE PUBLIC.T2 (PUBLIC.T2.F3 INTEGER, PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: RIGHT JOIN ON PUBLIC.T1.F1 = PUBLIC.T2.F3 (PUBLIC.T1.F1 INTEGER, PUBLIC.T1.F2 INTEGER, PUBLIC.T2.F3 INTEGER, PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: ORDER BY PUBLIC.T1.F1 ASC, PUBLIC.T2.F3 DESC
-- EXPLAIN: EXPR (F1 INTEGER, F2 INTEGER, F3 INTEGER, F4 INTEGER)
