...
-- EXPLAIN: RIGHT JOIN ON TRUE (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
...
-- EXPLAIN: $2:
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T2 (F3 INTEGER, F4 INTEGER)
-- EXPLAIN: RIGHT JOIN ON ":memory:".PUBLIC.T1.F1 = ":memory:".PUBLIC.T2.F3 (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: EXPR (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
...
-- EXPLAIN:   TABLE ":memory:".PUBLIC.T2 (F3 INTEGER, F4 INTEGER)
-- EXPLAIN: RIGHT JOIN ON ":memory:".PUBLIC.T1.F1 = ":memory:".PUBLIC.T2.F3 (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
-- EXPLAIN: ORDER BY ":memory:".PUBLIC.T1.F1 ASC, ":memory:".PUBLIC.T2.F3 DESC
-- EXPLAIN: EXPR (":memory:".PUBLIC.T1.F1 INTEGER, ":memory:".PUBLIC.T1.F2 INTEGER, ":memory:".PUBLIC.T2.F3 INTEGER, ":memory:".PUBLIC.T2.F4 INTEGER)
