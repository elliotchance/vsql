...
-- EXPLAIN: $1:
-- EXPLAIN:   TABLE T1 (X INTEGER, Y CHARACTER VARYING(16))
...
-- EXPLAIN: $1:
-- EXPLAIN:   TABLE T1 (X INTEGER, Y CHARACTER VARYING(16))
-- EXPLAIN: TABLE $1 (Y CHARACTER VARYING(16))
