...
-- EXPLAIN: TABLE $1 ($1.COL1 BIGINT)
-- EXPLAIN: EXPR (COL1 BIGINT)

EXPLAIN SELECT * FROM (VALUES 1.23);
-- EXPLAIN: $1:
-- EXPLAIN:   VALUES (COL1 DOUBLE PRECISION) = ROW(1.23)
-- EXPLAIN: TABLE $1 ($1.COL1 DOUBLE PRECISION)
...
-- EXPLAIN: TABLE $1 ($1.COL1 BIGINT, $1.COL2 CHARACTER VARYING, $1.COL3 BOOLEAN)
-- EXPLAIN: EXPR (COL1 BIGINT, COL2 CHARACTER VARYING, COL3 BOOLEAN)
...
-- EXPLAIN: TABLE T1 (T1.ABC BIGINT, T1.COL2 CHARACTER VARYING, T1.f BOOLEAN)
-- EXPLAIN: EXPR (ABC BIGINT, COL2 CHARACTER VARYING, f BOOLEAN)
...
-- EXPLAIN: TABLE $1 ($1.COL1 BIGINT, $1.COL2 CHARACTER VARYING)
-- EXPLAIN: EXPR (COL1 BIGINT, COL2 CHARACTER VARYING)
...
-- EXPLAIN: TABLE FOO (FOO.BAR BIGINT, FOO.BAZ CHARACTER VARYING)
-- EXPLAIN: EXPR (BAR BIGINT, BAZ CHARACTER VARYING)
...
-- EXPLAIN: TABLE T1 (T1.FOO BIGINT, T1.BAR BIGINT)
-- EXPLAIN: FETCH FIRST 2 ROWS ONLY
-- EXPLAIN: EXPR (FOO BIGINT, BAR BIGINT)
