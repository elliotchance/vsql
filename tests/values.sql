...
-- EXPLAIN: TABLE $1 ($1.COL1 INTEGER)
...
-- EXPLAIN: TABLE $1 ($1.COL1 INTEGER, $1.COL2 CHARACTER VARYING, $1.COL3 BOOLEAN)
-- EXPLAIN: EXPR (COL1 INTEGER, COL2 CHARACTER VARYING, COL3 BOOLEAN)
...
-- EXPLAIN: TABLE T1 (T1.ABC INTEGER, T1.COL2 CHARACTER VARYING, T1.f BOOLEAN)
-- EXPLAIN: EXPR (ABC INTEGER, COL2 CHARACTER VARYING, f BOOLEAN)
...
-- EXPLAIN: TABLE $1 ($1.COL1 INTEGER, $1.COL2 CHARACTER VARYING)
-- EXPLAIN: EXPR (COL1 INTEGER, COL2 CHARACTER VARYING)
...
-- EXPLAIN: TABLE FOO (FOO.BAR INTEGER, FOO.BAZ CHARACTER VARYING)
-- EXPLAIN: EXPR (BAR INTEGER, BAZ CHARACTER VARYING)
...
-- EXPLAIN: TABLE T1 (T1.FOO INTEGER, T1.BAR INTEGER)
-- EXPLAIN: FETCH FIRST 2 ROWS ONLY
-- EXPLAIN: EXPR (FOO INTEGER, BAR INTEGER)
