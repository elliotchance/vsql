...
-- EXPLAIN: $1:
-- EXPLAIN:   VALUES (COL1 NUMERIC, COL2 CHARACTER VARYING, COL3 BOOLEAN) = ROW(1, 'foo', TRUE)
-- EXPLAIN: TABLE $1 (COL1 NUMERIC, COL2 CHARACTER VARYING, COL3 BOOLEAN)
-- EXPLAIN: EXPR ($1.COL1 NUMERIC, $1.COL2 CHARACTER VARYING, $1.COL3 BOOLEAN)

EXPLAIN SELECT * FROM (VALUES 1, 'foo', TRUE) AS t1 (abc, col2, "f");
-- EXPLAIN: T1:
-- EXPLAIN:   VALUES (ABC NUMERIC, COL2 CHARACTER VARYING, "f" BOOLEAN) = ROW(1, 'foo', TRUE)
-- EXPLAIN: TABLE T1 (ABC NUMERIC, COL2 CHARACTER VARYING, "f" BOOLEAN)
-- EXPLAIN: EXPR (T1.ABC NUMERIC, T1.COL2 CHARACTER VARYING, T1."f" BOOLEAN)
...
-- EXPLAIN: VALUES (COL1 CHARACTER VARYING, COL2 NUMERIC) = ROW('hello', 1.22)
...
-- EXPLAIN: $1:
-- EXPLAIN:   VALUES (COL1 NUMERIC, COL2 CHARACTER VARYING) = ROW(123, 'hi'), ROW(456, 'there')
-- EXPLAIN: TABLE $1 (COL1 NUMERIC, COL2 CHARACTER VARYING)
-- EXPLAIN: EXPR ($1.COL1 NUMERIC, $1.COL2 CHARACTER VARYING)
...
-- EXPLAIN: FOO:
-- EXPLAIN:   VALUES (BAR NUMERIC, BAZ CHARACTER VARYING) = ROW(123, 'hi'), ROW(456, 'there')
-- EXPLAIN: TABLE FOO (BAR NUMERIC, BAZ CHARACTER VARYING)
-- EXPLAIN: EXPR (FOO.BAR NUMERIC, FOO.BAZ CHARACTER VARYING)
