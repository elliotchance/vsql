...
-- EXPLAIN: $1:
-- EXPLAIN:   VALUES (COL1 DOUBLE PRECISION) = ROW(1.23e0)
...
VALUES 'cool', 12.3;
-- COL1: cool (CHARACTER(4))
-- COL1: 12.3e0 (DOUBLE PRECISION)

/* types */
VALUES ROW('cool', 12.3);
-- COL1: cool (CHARACTER(4)) COL2: 12.3e0 (DOUBLE PRECISION)
...
-- EXPLAIN: VALUES (COL1 CHARACTER(5)) = ROW('hello'), ROW(1.22e0)

EXPLAIN VALUES ROW('hello', 1.22);
-- EXPLAIN: VALUES (COL1 CHARACTER(5), COL2 DOUBLE PRECISION) = ROW('hello', 1.22e0)
